...
var SwiperSliders = {
  init: function () {
    ...
    // Shopify Portfolio Slider
    if (document.querySelector(".shopify-portfolio-slider")) {
      new Swiper(".shopify-portfolio-slider", {
        loop: true,
        autoplay: { delay: 3000, disableOnInteraction: false },
        slidesPerView: "auto",
        spaceBetween: 24,
        navigation: {
          nextEl: ".shopify-portfolio-next",
          prevEl: ".shopify-portfolio-prev",
        },
        breakpoints: {
          1440: { spaceBetween: 24 },
          1201: { spaceBetween: 24 },
          1025: { spaceBetween: 24 },
          769: { spaceBetween: 20 },
          577: { spaceBetween: 18 },
          480: { spaceBetween: 18 },
          375: { spaceBetween: 18 },
    ...
    // Industries Slider
    if (document.querySelector(".industries-slider")) {
