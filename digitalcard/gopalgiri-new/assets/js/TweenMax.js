 ...
 */
		...
		var _checkTimeout = function() {
				...
				if (t.unref) {
					// allows a node process to exit even if the timeoutÃ¢â‚¬â„¢s callback hasn't been invoked. Without it, the node process could hang as this function is called every two seconds.
					t.unref();
				}
			};
		_checkTimeout();
