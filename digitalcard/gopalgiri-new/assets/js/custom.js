...
function downloadImage() {
  const imagePath = 'assets/images/gopal-giri-qr-code.png';
  const fileName = 'gopal-giri-qr-code.png';
...
/*------------------------------------- Share Scanner Img -------------------------------------*/
function shareImage() {
  const imageUrl = window.location.origin + '/digitalcard/gopal-giri/assets/images/gopal-giri-qr-code.png';
