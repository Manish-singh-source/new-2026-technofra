<?php
$pageTitle = 'CRM Development || Technofra Website';
...
------------------------------ */
    ...
    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(1) {
        animation-delay: .10s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(2) {
        animation-delay: .16s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(3) {
        animation-delay: .22s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(4) {
        animation-delay: .28s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(5) {
        animation-delay: .34s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(6) {
        animation-delay: .40s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(7) {
        animation-delay: .46s;
    }

    .tf-crm-stat.is-visible .tf-crm-stat__bars span:nth-child(8) {
        animation-delay: .52s;
    }
    ...
    .crm-hero-bg {
        ...
        min-height: 820px;
        background:
            url("assets/images/bg/banner_crm.png") center 140px / 100% auto no-repeat;
        overflow: hidden;
        /* space below header */
        padding-top: 175px;
    }
    ...
    @media(max-width:768px) {
        .crm-hero-bg {
            ...
            padding-top: 80px;
            background:
                url("assets/images/bg/banner_crm2.png") center top / cover no-repeat;
        }
   ...
   ============================================ */
    ...
    .tf-crm-stat--green .tf-crm-stat__icon {
        color: #1fa96b;
        background: #d7f0e0;
    }
    ...
    .tf-crm-stat--amber .tf-crm-stat__icon {
        color: #d99a1f;
        background: #faecc8;
    }
    ...
    .tf-crm-stat--blue .tf-crm-stat__icon {
        color: #4f6bff;
        background: #e1e6fb;
    }
    ...
    .tf-crm-stat__bars span:nth-child(1) {
        height: 28%;
    }

    .tf-crm-stat__bars span:nth-child(2) {
        height: 45%;
    }

    .tf-crm-stat__bars span:nth-child(3) {
        height: 35%;
    }

    .tf-crm-stat__bars span:nth-child(4) {
        height: 62%;
    }

    .tf-crm-stat__bars span:nth-child(5) {
        height: 48%;
    }

    .tf-crm-stat__bars span:nth-child(6) {
        height: 80%;
    }

    .tf-crm-stat__bars span:nth-child(7) {
        height: 60%;
    }

    .tf-crm-stat__bars span:nth-child(8) {
        height: 100%;
    }
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const motionItems = [{
                selector: ".tf-brand-strip__inner",
                reveal: "tf-reveal-up"
            },
            {
                selector: ".tf-steps__header",
                reveal: "tf-reveal-up"
            },
            {
                selector: ".tf-steps__visual",
                reveal: "tf-reveal-media"
            },
            {
                selector: ".tf-step-card",
                reveal: "tf-reveal-left",
                alternate: "tf-reveal-right"
            },
            {
                selector: ".tf-why__header",
                reveal: "tf-reveal-up"
            },
            {
                selector: ".tf-why-card",
                reveal: "tf-reveal-zoom"
            },
            {
                selector: ".tf-crm-split__header",
                reveal: "tf-reveal-up"
            },
            {
                selector: ".tf-crm-dash",
                reveal: "tf-reveal-media"
            },
            {
                selector: ".tf-crm-list",
                reveal: "tf-reveal-media"
            },
            {
                selector: ".tf-crm-list__row",
                reveal: "tf-reveal-left",
                alternate: "tf-reveal-right"
            },
            {
                selector: ".tf-crm-dark-content",
                reveal: "tf-reveal-up"
            },
            {
                selector: ".tf-crm-dark-image",
                reveal: "tf-reveal-media"
            },
            {
                selector: ".tf-crm-feature",
                reveal: "tf-reveal-left",
                alternate: "tf-reveal-right"
            },
            {
                selector: ".tf-crm-faq-heading",
                reveal: "tf-reveal-up"
            },
            {
                selector: ".tf-crm-faq-graphic",
                reveal: "tf-reveal-media"
            },
            {
                selector: ".tf-crm-faq-list .faq-item",
                reveal: "tf-reveal-up"
            }
        ];
