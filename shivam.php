...
<style>
  ...
  .svmcms-hero-visual {
    ...
    z-index: 1;
    min-width: 0;
    /* prevents flex/grid overflow pushing text */
  }
  ...
  .svmcms-feature-col {
    ...
    /* placeholder so lg divider doesn't shift layout */
  }
  ...
  @media (max-width: 1399.98px) {
    ...
    .svmcms-hero {
      padding-block: clamp(2.5rem, 5vw, 4.5rem) 3rem;
    }
  ...
  @media (max-width: 991.98px) {
    ...
    /* avoid clashing with centered stacked text */
  ...
  @media (max-width: 767.98px) {
    ...
    .svmcms-feature-col:nth-last-child(-n+2) {
      border-bottom: none;
    }
  }
...
<style>
  ...
  * {
  ...
  .sg-divider {
    ...
    margin: clamp(1.5rem, 1.2rem + 1.2vw, 2.25rem) 0;
  }
  ...
  .sg-secondary .sg-swatch-row {
    grid-template-columns: repeat(5, minmax(0, 1fr));
  }

  .sg-secondary .sg-swatch {
  ...
  .sg-accent {
    ...
    padding-left: clamp(1rem, 0.85rem + 0.6vw, 1.75rem);
  }
  ...
  .sg-gradients .grad-row {
    display: flex;
    gap: 0.75rem;
  }

  .sg-gradients .sg-swatch {
    height: clamp(56px, 5vw, 76px);
    flex: 1 1 50%;
    align-items: center;
    justify-content: center;
  ...
  .sg-type-sample.poppins .aa {
    color: var(--sg-teal);
    font-family: 'Poppins', sans-serif;
  }

  .sg-type-sample.opensans .aa {
    color: var(--sg-charcoal);
  ...
  .sg-inuse-label .brand img {
    width: 30px;
    height: 30px;
  }

  .sg-inuse-label .brand span {
    font-weight: 700;
    color: var(--sg-teal);
    font-size: var(--p);
  }
...
============================================ */
  ...
  .rfe-section {
    ...
    padding: clamp(2.5rem, 2rem + 3vw, 6rem) 0 10px 0;
    overflow: hidden;
    position: relative;
  }
  ...
  .rfe-feature {
    ...
    gap: 1rem;
    padding: 1.1rem 0;
    border-bottom: 1px solid rgba(15, 122, 114, 0.15);
  }

  .rfe-feature:last-child {
    border-bottom: none;
  }

  .rfe-feature-icon {
    flex: 0 0 auto;
    width: clamp(46px, 3vw + 30px, 56px);
    height: clamp(46px, 3vw + 30px, 56px);
    border-radius: 50%;
    background: var(--teal);
    color: #fff;
    display: flex;
  ...
  .rfe-feature-text {
    min-width: 0;
    /* prevents text overflow from flex sibling */
  }
  ...
  /* ---------- Device mockup stage (single real image) ---------- */
  .rfe-stage {
    position: relative;
    width: 100%;
    display: flex;
  ...
  .rfe-strip {
    background: #fff;
    padding: clamp(1.75rem, 1.4rem + 1.5vw, 2.75rem) 0;
    position: relative;
  }
...
============================================ */
  ...
  @media (max-width: 991.98px) {
    ...
    /* full column width once stacked below copy */
    .rfe-strip .col-divider {
      border-left: none;
      ...
      <div class="sg-inuse-hero">
        <div class="sg-inuse-hero-inner">
          ...
          <div class="sg-inuse-feats">
            <div class="sg-inuse-feat"><i class="fa-solid fa-certificate"></i>
              <div class="lbl">Quality Assurance</div>
            </div>
            <div class="sg-inuse-feat"><i class="fa-solid fa-flask"></i>
              <div class="lbl">Wide Range of Chemicals</div>
            </div>
            <div class="sg-inuse-feat"><i class="fa-solid fa-leaf"></i>
              <div class="lbl">Safe &amp; Compliant Processes</div>
            </div>
            <div class="sg-inuse-feat"><i class="fa-solid fa-truck-fast"></i>
              <div class="lbl">Reliable Supply &amp; Support</div>
            </div>
          </div>
...
<section class="rfe-section">
  <div class="container">
    <div class="row align-items-center gy-5">
      <!-- LEFT: copy -->
      <div class="col-12 col-lg-6">
        <span class="rfe-eyebrow">Responsive Experience</span>
        <span class="rfe-eyebrow-rule"></span>
        <h2 class="rfe-heading">Built for<span>Every Screen</span></h2>
        <p class="rfe-lead">
          The Shivam Industries website is fully optimized for desktop,
          tablet, and mobile devices — making it easy to explore our
          chemical products, request quotes, and connect with our team
          anytime, anywhere.
        </p>

        <div class="rfe-feature">
          <div class="rfe-feature-icon">
            <i class="fa-solid fa-desktop"></i>
          </div>
          <div class="rfe-feature-text">
            <h3>Desktop Friendly</h3>
            <p>A seamless browsing experience on larger screens.</p>
          </div>
        </div>
        ...
        <div class="rfe-feature">
          ...
          <div class="rfe-feature-text">
            <h3>Tablet Ready</h3>
            <p>Perfectly adapted layouts for tablets.</p>
          </div>
        </div>
        ...
        <div class="rfe-feature">
          ...
          <div class="rfe-feature-text">
            ...
            <p>Fast, user-friendly, and built for on-the-go access.</p>
          </div>
        </div>
      </div>

      <!-- RIGHT: device mockup (single real image) -->
      <div class="col-12 col-lg-6">
        <div class="rfe-stage">
          <img
            src="assets/images/portfolios/shivam/devices-mockup.png"
            alt="Shivam Industries website shown on laptop, tablet, and phone" />
        </div>
      </div>
    </div>
  </div>
...
<!-- Bottom feature strip -->
<section class="rfe-strip">
  <div class="container">
    <div class="row gy-4">
      <div class="col-12 col-md-4">
        <div class="rfe-strip-item">
          <i class="fa-solid fa-shield-halved"></i>
          <div>
            <h4>Consistent &amp; Reliable</h4>
            <p>Unified experience across every device.</p>
          </div>
        </div>
      </div>
      <div class="col-12 col-md-4 col-divider">
        <div class="rfe-strip-item">
          <i class="fa-solid fa-gauge-high"></i>
          <div>
            <h4>Faster &amp; Smoother</h4>
            <p>Optimized performance for quick browsing.</p>
          </div>
        </div>
      </div>
      <div class="col-12 col-md-4 col-divider">
        <div class="rfe-strip-item">
          ...
          <div>
            <h4>User Focused</h4>
            <p>
              Designed to help you find products and get quotes with ease.
            </p>
          </div>
        </div>
      </div>
